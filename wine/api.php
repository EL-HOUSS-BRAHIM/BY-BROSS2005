...
$ch = curl_init();
  ////curl_setopt($ch, CURLOPT_PROXY, $proxySocks);
  /////curl_setopt($ch, CURLOPT_PROXYTYPE, CURLPROXY_SOCKS5);
  curl_setopt($ch, CURLOPT_URL, 'https://api.stripe.com/v1/payment_pages/cs_live_a11GSZViBoCWQqJRWc06yCJEIwyFuPUICbguvEOgXHK6bU4zKXIY7G6Aeu/confirm');
  curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
  curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
  curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
...
'authority: api.stripe.com',
'method: POST',
'path: /v1/payment_pages/cs_live_a11GSZViBoCWQqJRWc06yCJEIwyFuPUICbguvEOgXHK6bU4zKXIY7G6Aeu/confirm',
'scheme: https',
'origin: https://pay.openai.com',
'referer: https://pay.openai.com/',
'sec-fetch-site: cross-site',
